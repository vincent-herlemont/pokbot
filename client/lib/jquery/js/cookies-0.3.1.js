/**
 * Created by Vincent on 20/12/13.
 */
...
(function (e) {
    ...
    a._getExtendedOptions = function (b) {
        return{path: b &&
            b.path || a.defaults.path, domain: b && b.domain || a.defaults.domain, expires: b && b.expires || a.defaults.expires, secure: b && b.secure !== e ? b.secure : a.defaults.secure}
    };
    ...
    a._generateCookieString = function (b, a, c) {
        ...
        b += c.expires ? ";expires=" + c.expires.toGMTString() : "";
